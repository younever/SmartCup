...
import com.example.smartcup.ChatListAdapter;
...
public class deviceActivity extends Activity {
	...
	private void init() {		   
        ...
        Set<BluetoothDevice> pairedDevices = mBtAdapter.getBondedDevices();         //返回已经匹配的设备
		...
		serviceButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				startActivity(new Intent(deviceActivity.this,chatActivity.class));
			}
		});
			...
			public void onClick(View arg0) {
			 	...
			 	else
			 	{
					...
					if (pairedDevices.size() > 0) {
			        	...
			        	list.add(new SiriListItem("没有已经匹配设备", true));
			        	mAdapter.notifyDataSetChanged();
			    		mListView.setSelection(list.size() - 1);
				     }					
			        /* 开始搜索 */
